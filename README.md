...
##### 1. Data quality control and filtering
   a) process BAM file from scRNA-Seq in a way that reads with any of following patterns be filtered out: quality is lower than 10,  is unmapped segment, is secondary alignment, not passing filters, is PCR or optical duplicate, or is supplementary alignment.  The BAM file will be further filtered to keep only the reads with white listed barcodes to reduce technical noises.  Finally it will be marked for duplication, sorted and indexed.
